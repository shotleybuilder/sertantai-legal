defmodule SertantaiLegal.Repo.Migrations.AddCompiledApplicability do
  @moduledoc """
  Add compiled_applicability (jsonb) column to legal_register.
  Stores compiled expression trees from fractalaw for applicability evaluation.
  ...
  def up do
    ...
    alter table(:legal_register) do
      add :compiled_applicability, :jsonb, default: nil
    end
    ...
    # 6. Recreate DELETE trigger (unchanged)
    execute("""
  ...
  def down do
    ...
    alter table(:legal_register) do
      remove :compiled_applicability
    end

    # View + triggers must be rebuilt from previous state (omitted for brevity)
  end
end
