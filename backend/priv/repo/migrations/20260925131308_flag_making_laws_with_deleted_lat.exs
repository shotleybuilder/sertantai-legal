defmodule SertantaiLegal.Repo.Migrations.FlagMakingLawsWithDeletedLat do
  @moduledoc """
  `making_funnel.next_action = 'review_lat_deleted'` for laws that are Making
  but whose LAT was parsed and later deleted (a not-Making clean-up). The
  Making verdict (often a stale human review of an amending SI) and the
  deletion disagree; without this they were hidden from the `lat_parse` action.
  39 UK laws on 2026-09-25 (QQ-01a).
  """
